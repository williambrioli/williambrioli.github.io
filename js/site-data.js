...
window.SITE_DATA = { // Cria um objeto global chamado SITE_DATA no objeto window (acessível em qualquer lugar do site).
  contact: { // Inicio do bloco "contact": guarda dados de contato (nome, título, telefone, horário, textos do botão).
    ...
    title: "Psicanalista Clínico Integrativo | Palestrante e Consultor em Saúde Emocional, Soft Skills e Desenvolvimento Humano | Bacharel em Psicologia pela EBWU (Miami, Flórida - EUA)", // O título ou profissão que será exibido junto do nome.
