...
window.SITE_DATA = { // Cria um objeto global chamado SITE_DATA no objeto window (acessível em qualquer lugar do site).
  contact: { // Inicio do bloco "contact": guarda dados de contato (nome, título, telefone, horário, textos do botão).
    ...
    title: "Psicanalista Clínico | Consultor Empresarial | Master Trainer em Desenvolvimento Humano de Gestores, Líderes e Equipes | Bacharel em Psicologia (EBWU – Miami, EUA) | Pós-graduações em Neurociências, CNV, PNL, TCC e áreas afins.", // O título ou profissão que será exibido junto do nome.
